...
Note: For the sake of focusing on the theory, we will assume that the response variables in the example are normally distributed. (Eventually this document will be refactored with better example data)
